...
\begin{quote}
    ...
    \begin{quote}
         ...
         ``Split'' die beiden Signale voneinander trennen.\vspace{1em}
         ...
         \begin{figure}[H]
            \centering
                \includegraphics[scale=0.2, trim = 0cm 0cm 0cm 0cm, clip]{./Bilder/Aufgabe_2_1}
...
\begin{quote}
    ...
    \begin{quote}
        ...
        Quantisierungsstufen liegen um $0V$ dichter beieinander als bei $\pm 1.5V$.\\
    ...
    \begin{quote}
        ...
        Sie ist offensichtlich linear und die Abstände zwischen den Quantisierungsstufen sind gleich groß. Das 
        
        \TODO{Boris: überarbeiten} \\
          hat daher
        gleichmäßig verteilte Quantisierungsstufen.Hierbei handelt es sich offensichlich um eine lineare Kennlinie die gleichmäßig verteilte Quantisierungsschritte besitzt. Das lässt darauf schließen, dass die Daten aus der Vorbereitungsaufgabe und aus
