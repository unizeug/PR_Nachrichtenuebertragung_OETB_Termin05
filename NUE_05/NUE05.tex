...
\begin{quote}
    ...
    \begin{quote}
         ...
         Als Signal sollten wir ein Dreieckssignal mit einer Aplitude von ein wenig über $4V_{pp}$ verwenden. Diese
         Amplitude sollen wir wählen, da der eingebaute Quantisierer auf ein Spannungsbereich von $\pm 2V$ ausgelegt
         ...
         und errechnen uns die PCM-Kennlinie des Quentisierers. Die genaue Kennlinie ist in der Auswertung zu sehen.
...
\begin{quote}
    ...
    \begin{quote}
        ...
        $0V$ ist wesentlich höher aufgelöst als an den Rändern der Kennlinie. Das liegt daran, dass die
        Quantisierungsstufen nicht gleichmäßig verteilt sind.\\
        des weiteren fällt auf, dass sowohl am unteren Bereich der Kennlinie als auch am oberen Bereich einige Messwerde
        abgeschnitten wurden. Das erkennt man daran, dass die Kennlinie an diesen Werten in die Sättigung geht.\\
        Merkwürdig ist, dass die Kennlinie im unteren Bereich schon bei $-1.5V$ in die Sättigung geht und im oberen
        Bereich erst bei $2V$.\\
        Das kann entweder an einem Fehler in unserem Skript liegen oder einfach auf einen unsymmetrischen Quantisierer
        zurückzuführen sein.
    ...
    \begin{quote}
        ...
        Diese PCM-Encoder-Kennlinie unterscheidet sich auffällig von der aus der Vorbereitungsaufgabe. Hierbei
        handelt es sich offensichlich um eine lineare Kennlinie die gleichmäßig verteilte
        Quantisierungsschritte besitzt. Das lässt darauf schließen, dass die Daten aus der Vorbereitungsaufgabe und aus
        dieser Aufgabe mit zwei verschiedenen Quantisierern moduliert wurden.\\
        Bei der Messung wurde der Quantisierer so angesteuert, dass er seinen maximalen Bereich errecht. Dies lässt
        sich an der sättigung erkennen, die bei $-2,4V$ und bei $2,6V$ beginnt. Dass diese beiden Startpunkte für die
        Sättigung nicht Betragsmäßig gleich sind, spricht für einen unsymmetrischen Quantisierer.
