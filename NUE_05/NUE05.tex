...
\begin{quote}
    ...
    \begin{quote}
        ...
        \begin{quote}
            ...
            sollte als $\frac{1}{2} U_{LSB}$. Jedoch wurde in der
            Vorbereitungs- und ersten Praktikumsaufgabe die Beobachtung
            gemacht, dass der Quantisierer bis zu 4 Stufen für einen
            Spannungswert zuweist. Daher erwarten wir Fehler bis zu $\pm 0.07\
            V$. Dass der Quantisierungsfehler hingegen ganze $\pm 0.7\ V$ erreicht ist auf die niedrige Abtastfrequenz
            zurück zu führen ist. Ein Vergleich mit dem Quantisierungsfehler bei dem Sinussignal
            ...
            anzeigt. Auch dieser Wert übertrifft den erwarteten Quantisierungsfehler ist jedoch wesentlich dichter an
            ihm dran.\\
            Der Unterschied zu der Messung mit $8kHz$ Taktfrequenz ist nicht zu übersehen.\\
            Daran lässt sich erkennen, dass der Quantisierungsfehler sowohl von der Auflösung des Quantisierers abhängt
            als auch von der verwendeten Abtastfrequenz.
		...
		Quantisierungsfehlers bei den Messungen mit einer Abtastrate von $8kHz$ höhere Leistungen bei den niedrigen
	    Frequenzen aufweist als bei der Abtastrate $100 kHz$. Als Ursache vermuten wir das auffallend höhere
	    Quantisierungrauschen bei der niedrigereren Abtastrate.\\
		\vspace{1em}
...
\begin{quote}
    ...
    Abweichungen zwischen den Signalen. Dabei fiel auf, dass der Quantisierungsfehler nicht nur von der Auflösung des
    Quantisierers abhängt sondern auch von der verwendeten Abtastrate. Mit den Leistungsdichtespektren dieser
    Quantisierungsfehler wurden die Ergebnisse unseren Erwartungen nach bestätigt.
