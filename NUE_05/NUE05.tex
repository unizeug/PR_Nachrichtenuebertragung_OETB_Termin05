...
\begin{quote}
	...
	\TODO{nur durch abtastung entsteht doch kein PAM signal. der Abtastimpuls müsste doch eine nullflanke haben} \\
	...
	\TODO{Klären: meiner Meinung nach gibt es gar keine digitalen Kanäle} \\
	...
	\TODO{was willst du mit dem nächsten satz
	sagen?} \\
...
\begin{quote}
    ...
    \begin{quote}
		...
		Bei beiden Signalen fällt auf, dass 
